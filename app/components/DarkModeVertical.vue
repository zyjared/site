...
<template>
  <div
    class="relative h-2em w-1em flex cursor-pointer items-center rounded-full ring-1.5px ring-neutral/20 transition-colors duration-300 bg-ctx-text/3"
    @click="toggleColorMode"
  >
    <div
      ref="scope"
      class="absolute left-0 top-0 h-1em w-1em flex items-center justify-center rounded-full p-[0.135em] shadow transition-colors bg-ctx-bg/75"
    >
      <div
