...
<template>
  <div class="my-6 border border-neutral/10 rounded-xl bg-neutral/5">
    <!-- 顶部信息栏 -->
    <div class="flex items-center justify-between border-b border-neutral/10 px-4 py-2">
      <div class="flex-center gap-2">
        ...
        <!-- 语言标识 -->
        <div v-if="language" class="ml-2 text-xs text-neutral">
          {{ language }}
        </div>

        <!-- 文件名 -->
        <div v-if="filename" class="text-xs text-neutral/60">
          · {{ filename }}
        </div>
      </div>
