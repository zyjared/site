...
import { matchAllTags } from '../.vitepress/plugins/vite-plugin-demoify/match'
import { transformCodeToMd } from '../.vitepress/plugins/vite-plugin-demoify/transform'

describe.skip('demoifyPlugin', () => {
  const v = `
